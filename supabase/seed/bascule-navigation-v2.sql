...
begin
  ...
  -- elles ne font pas partie des treize familles que cette bascule doit
  -- trouver. Seule la forme de reference de la V3 est comptee.
...
--
-- Bornee aux treize familles de la V2 : les familles des versions suivantes,
-- posees par migration et volontairement invisibles tant qu'elles sont vides,
-- portent elles aussi une reference externe. Sans cette borne, rejouer la
-- bascule publiait des rayons deserts. La forme de reference de la V3 —
-- « IMG-04 », « TXT-07 » — les distingue sans rien enumerer.
...
begin
  ...
  -- Les familles des versions suivantes sont vides par construction jusqu'a
  -- leur lot : elles sont aussi invisibles, donc elles ne font de cul-de-sac
  -- pour personne. Seules les treize de la V3 sont comptees.

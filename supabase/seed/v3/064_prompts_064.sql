-- Lot 64 : raccourcis 187 a 189 sur 320.
--
...
select * from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-148","command":"/voiceguide","slug":"voiceguide","name":"Guide de voix","mode":"texte","family_ref":"TXT-03","short_description":"Définit personnalité, principes, vocabulaire, formulations à éviter, exemples par canal et contrôles de cohérence.","result_summary":"Un livrable textuel final, clair et actionnable.","intention":"Formaliser une voix de marque utilisable par toute une équipe.","use_cases":["Guide de voix à partir d’un contexte réel pour obtenir un résultat directement exploitable.","/voiceguide avec la source, l’objectif et les contraintes utiles."],"tags":["communication-contenu","voiceguide"],"expected_input":"facultative si le brief contient les informations indispensables","minimal_context":"Objectif compréhensible et variables indispensables disponibles.","sufficient_context":"Objectif, source, public et sortie déductibles avec confiance.","required_variables":["marque","exemples"],"optional_variables":["format","niveau de détail","ton","contraintes","exemples"],"default_values":"Réponse claire, structurée, actionnable et proportionnée aux données disponibles.","expected_output":"Un livrable textuel final, clair et actionnable.","output_format":"Livrable final structuré, directement réutilisable, avec hypothèses et limites si nécessaires.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"La qualité dépend des sources et du contexte; aucune validation juridique, médicale, financière ou de sécurité implicite.","usage_conditions":"Respecter confidentialité, propriété intellectuelle et règles applicables; validation humaine pour les sujets sensibles.","fallback_if_incomplete":"Fournir une structure ou une liste des données attendues, sans inventer de résultat.","blocking_condition":"Poser uniquement les questions indispensables si l’objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P1","is_featured":false,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/communication-contenu/voiceguide.webp","default_image_alt":"Guide de voix — illustration éditoriale","sort_order":30,"version_label":"v2.1","payload":"[RaccourcIA — /voiceguide]\nRôle : exécuter « Guide de voix ».\nObjectif : Formaliser une voix de marque utilisable par toute une équipe.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : marque; exemples.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Quelle direction visuelle retenir ? A. Réaliste premium B. Éditoriale C. Graphique D. Autre\n2. Que faut-il retenir pour « exemples » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nDéfinit personnalité, principes, vocabulaire, formulations à éviter, exemples par canal et contrôles de cohérence.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nLivrable final structuré, directement réutilisable, avec hypothèses et limites si nécessaires.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/voiceguide avec la source, l’objectif et les contraintes utiles.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « marque » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l’objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"new_v2"},{"external_ref":"RCI-TXT-149","command":"/moderationreply","slug":"moderationreply","name":"Réponse de modération","mode":"texte","family_ref":"TXT-03","short_description":"Rédige une réponse factuelle, empathique et brève, distingue public et privé, et prévoit l’escalade si nécessaire.","result_summary":"Un livrable textuel final, clair et actionnable.","intention":"Répondre publiquement à un commentaire difficile avec mesure.","use_cases":["Réponse de modération à partir d’un contexte réel pour obtenir un résultat directement exploitable.","/moderationreply avec la source, l’objectif et les contraintes utiles."],"tags":["communication-contenu","moderationreply"],"expected_input":"source requise si le prompt doit analyser un contenu existant","minimal_context":"Objectif compréhensible et variables indispensables disponibles.","sufficient_context":"Objectif, source, public et sortie déductibles avec confiance.","required_variables":["commentaire","contexte"],"optional_variables":["format","niveau de détail","ton","contraintes","exemples"],"default_values":"Réponse claire, structurée, actionnable et proportionnée aux données disponibles.","expected_output":"Un livrable textuel final, clair et actionnable.","output_format":"Livrable final structuré, directement réutilisable, avec hypothèses et limites si nécessaires.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"La qualité dépend des sources et du contexte; aucune validation juridique, médicale, financière ou de sécurité implicite.","usage_conditions":"Respecter confidentialité, propriété intellectuelle et règles applicables; validation humaine pour les sujets sensibles.","fallback_if_incomplete":"Fournir une structure ou une liste des données attendues, sans inventer de résultat.","blocking_condition":"Poser uniquement les questions indispensables si l’objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"document","output_type":"text","risk_level":"faible","priority":"P1","is_featured":false,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/communication-contenu/moderationreply.webp","default_image_alt":"Réponse de modération — illustration éditoriale","sort_order":31,"version_label":"v2.1","payload":"[RaccourcIA — /moderationreply]\nRôle : exécuter « Réponse de modération ».\nObjectif : Répondre publiquement à un commentaire difficile avec mesure.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : document ou texte. Entrées acceptées : pdf; docx; texte collé; notes; URL accessible.\nVariables indispensables : commentaire; contexte.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Que faut-il retenir pour « commentaire » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\n2. Que faut-il retenir pour « contexte » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nRédige une réponse factuelle, empathique et brève, distingue public et privé, et prévoit l’escalade si nécessaire.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nLivrable final structuré, directement réutilisable, avec hypothèses et limites si nécessaires.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/moderationreply avec la source, l’objectif et les contraintes utiles.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « commentaire » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l’objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"new_v2"},{"external_ref":"RCI-TXT-150","command":"/contentbrief","slug":"contentbrief","name":"Brief de contenu","mode":"texte","family_ref":"TXT-03","short_description":"Définit objectif, audience, angle, messages, structure, sources, contraintes, CTA et critères de validation.","result_summary":"Un livrable textuel final, clair et actionnable.","intention":"Cadrer un contenu avant sa production.","use_cases":["Brief de contenu à partir d’un contexte réel pour obtenir un résultat directement exploitable.","/contentbrief avec la source, l’objectif et les contraintes utiles."],"tags":["communication-contenu","contentbrief"],"expected_input":"facultative si le brief contient les informations indispensables","minimal_context":"Objectif compréhensible et variables indispensables disponibles.","sufficient_context":"Objectif, source, public et sortie déductibles avec confiance.","required_variables":["sujet","audience","canal"],"optional_variables":["format","niveau de détail","ton","contraintes","exemples"],"default_values":"Réponse claire, structurée, actionnable et proportionnée aux données disponibles.","expected_output":"Un livrable textuel final, clair et actionnable.","output_format":"Livrable final structuré, directement réutilisable, avec hypothèses et limites si nécessaires.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"La qualité dépend des sources et du contexte; aucune validation juridique, médicale, financière ou de sécurité implicite.","usage_conditions":"Respecter confidentialité, propriété intellectuelle et règles applicables; validation humaine pour les sujets sensibles.","fallback_if_incomplete":"Fournir une structure ou une liste des données attendues, sans inventer de résultat.","blocking_condition":"Poser uniquement les questions indispensables si l’objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":3,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P1","is_featured":false,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/communication-contenu/contentbrief.webp","default_image_alt":"Brief de contenu — illustration éditoriale","sort_order":32,"version_label":"v2.1","payload":"[RaccourcIA — /contentbrief]\nRôle : exécuter « Brief de contenu ».\nObjectif : Cadrer un contenu avant sa production.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : sujet; audience; canal.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 3 questions.\n1. Quel sujet faut-il traiter ? A. Objet joint B. Personne jointe C. Lieu ou scène D. Autre\n2. À qui s’adresse le résultat ? A. Clients B. Prospects C. Équipe interne D. Autre\n3. Que faut-il retenir pour « canal » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nDéfinit objectif, audience, angle, messages, structure, sources, contraintes, CTA et critères de validation.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nLivrable final structuré, directement réutilisable, avec hypothèses et limites si nécessaires.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/contentbrief avec la source, l’objectif et les contraintes utiles.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « sujet » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l’objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"new_v2"}]$raccourcia$::jsonb) as d(
...
select p.id, ia.id,
       ...
       d.support_notes
from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-148","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-148","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-148","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-149","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-149","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-149","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-150","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-150","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-150","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."}]$raccourcia$::jsonb) as d(
...
from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-148","sort_order":1,"variable":"marque","question":"Quelle direction visuelle retenir ?","choices":["Réaliste premium","Éditoriale","Graphique","Autre"],"default_value":"Cohérente avec la source","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-148","sort_order":2,"variable":"exemples","question":"Que faut-il retenir pour « exemples » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-149","sort_order":1,"variable":"commentaire","question":"Que faut-il retenir pour « commentaire » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-149","sort_order":2,"variable":"contexte","question":"Que faut-il retenir pour « contexte » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-150","sort_order":1,"variable":"sujet","question":"Quel sujet faut-il traiter ?","choices":["Objet joint","Personne jointe","Lieu ou scène","Autre"],"default_value":"Sujet principal de la source","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-150","sort_order":2,"variable":"audience","question":"À qui s’adresse le résultat ?","choices":["Clients","Prospects","Équipe interne","Autre"],"default_value":"Public principal du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-150","sort_order":3,"variable":"canal","question":"Que faut-il retenir pour « canal » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."}]$raccourcia$::jsonb) as d(
...
begin
  ...
  if v_total < 189 then
    raise exception 'Lot 64 incomplet : % raccourcis importes au lieu de 189.', v_total;
  end if;
end $ctrl$;

-- Lot 90 : raccourcis 265 a 267 sur 320.
--
...
select * from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-046","command":"/dialogue","slug":"dialogue","name":"Dialogue naturel","mode":"texte","family_ref":"TXT-06","short_description":"Produit un echange vivant avec voix distinctes et sous-texte.","result_summary":"Texte final pret a publier, envoyer ou integrer.","intention":"Ecrire un dialogue credible.","use_cases":["Dialogue naturel à partir d'un contexte réel pour obtenir un livrable directement exploitable.","/dialogue pour transformer un brief court en dialogue naturel exploitable."],"tags":["dialogue","fiction","script"],"expected_input":"facultative","minimal_context":"Objectif et matière source ou brief compréhensibles.","sufficient_context":"Objectif, audience ou destinataire, source et format déductibles du contexte.","required_variables":["personnages","situation"],"optional_variables":["ton","longueur","canal","exemples","mots_interdits"],"default_values":"Ton clair, direct et professionnel; longueur moyenne; structure scannable.","expected_output":"Texte final pret a publier, envoyer ou integrer.","output_format":"Titre + texte final + variante courte si utile.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"Ne remplace pas une validation juridique, medicale ou financiere; chiffres et sources doivent etre fournis.","usage_conditions":"Utiliser des données autorisées; anonymiser les informations sensibles; faire valider les domaines réglementés.","fallback_if_incomplete":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","blocking_condition":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P0","is_featured":true,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/produit-tech-competences/dialogue.webp","default_image_alt":"Dialogue naturel — illustration éditoriale","legacy_category":"Apprentissage & carrière","legacy_subcategory":"Études & créativité","sort_order":12,"version_label":"v2.1","payload":"[RaccourcIA — /dialogue]\nRôle : exécuter « Dialogue naturel ».\nObjectif : Ecrire un dialogue credible.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : personnages; situation.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Que faut-il retenir pour « personnages » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\n2. Que faut-il retenir pour « situation » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nProduit un echange vivant avec voix distinctes et sous-texte.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nTitre + texte final + variante courte si utile.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/dialogue pour transformer un brief court en dialogue naturel exploitable.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « personnages » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"existing_optimized"},{"external_ref":"RCI-TXT-081","command":"/userstories","slug":"userstories","name":"User stories","mode":"texte","family_ref":"TXT-06","short_description":"Produit rôle, besoin, valeur, contexte et dépendances sans surspécifier.","result_summary":"Livrable textuel final et actionnable.","intention":"Transformer des besoins en user stories exploitables.","use_cases":["User stories à partir d'un contexte réel pour obtenir un livrable directement exploitable.","/userstories avec la source et l'objectif fournis par l'utilisateur."],"tags":["produit & ux"],"expected_input":"facultative","minimal_context":"Objectif et matière source ou brief compréhensibles.","sufficient_context":"Objectif, audience ou destinataire, source et format déductibles du contexte.","required_variables":["besoins","utilisateur"],"optional_variables":["ton","longueur","canal","exemples","contraintes"],"default_values":"Ton clair professionnel; structure scannable; longueur moyenne.","expected_output":"Livrable textuel final et actionnable.","output_format":"Texte final prêt à publier, envoyer ou intégrer.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"La qualité dépend des sources; aucune validation juridique, médicale ou financière implicite.","usage_conditions":"Utiliser des données autorisées; anonymiser les informations sensibles; faire valider les domaines réglementés.","fallback_if_incomplete":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","blocking_condition":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P1","is_featured":false,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/produit-tech-competences/userstories.webp","default_image_alt":"User stories — illustration éditoriale","legacy_category":"Produit & expérience","legacy_subcategory":"Produit & UX","sort_order":13,"version_label":"v2.1","payload":"[RaccourcIA — /userstories]\nRôle : exécuter « User stories ».\nObjectif : Transformer des besoins en user stories exploitables.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : besoins; utilisateur.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Que faut-il retenir pour « besoins » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\n2. À qui s’adresse le résultat ? A. Clients B. Prospects C. Équipe interne D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nProduit rôle, besoin, valeur, contexte et dépendances sans surspécifier.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nTexte final prêt à publier, envoyer ou intégrer.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/userstories avec la source et l'objectif fournis par l'utilisateur.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « besoins » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"existing_optimized"},{"external_ref":"RCI-TXT-082","command":"/acceptancecriteria","slug":"acceptancecriteria","name":"Critères d'acceptation","mode":"texte","family_ref":"TXT-06","short_description":"Écrit scénarios Given/When/Then, cas limites et exclusions.","result_summary":"Livrable textuel final et actionnable.","intention":"Définir des critères testables pour une fonctionnalité.","use_cases":["Critères d'acceptation à partir d'un contexte réel pour obtenir un livrable directement exploitable.","/acceptancecriteria avec la source et l'objectif fournis par l'utilisateur."],"tags":["support & qualité"],"expected_input":"facultative","minimal_context":"Objectif et matière source ou brief compréhensibles.","sufficient_context":"Objectif, audience ou destinataire, source et format déductibles du contexte.","required_variables":["fonctionnalite","regles"],"optional_variables":["ton","longueur","canal","exemples","contraintes"],"default_values":"Ton clair professionnel; structure scannable; longueur moyenne.","expected_output":"Livrable textuel final et actionnable.","output_format":"Texte final prêt à publier, envoyer ou intégrer.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"La qualité dépend des sources; aucune validation juridique, médicale ou financière implicite.","usage_conditions":"Utiliser des données autorisées; anonymiser les informations sensibles; faire valider les domaines réglementés.","fallback_if_incomplete":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","blocking_condition":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P1","is_featured":false,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/produit-tech-competences/acceptancecriteria.webp","default_image_alt":"Critères d'acceptation — illustration éditoriale","legacy_category":"Produit & expérience","legacy_subcategory":"Support & tech","sort_order":14,"version_label":"v2.1","payload":"[RaccourcIA — /acceptancecriteria]\nRôle : exécuter « Critères d'acceptation ».\nObjectif : Définir des critères testables pour une fonctionnalité.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : fonctionnalite; regles.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Que faut-il retenir pour « fonctionnalite » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\n2. Que faut-il retenir pour « regles » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nÉcrit scénarios Given/When/Then, cas limites et exclusions.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nTexte final prêt à publier, envoyer ou intégrer.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/acceptancecriteria avec la source et l'objectif fournis par l'utilisateur.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « fonctionnalite » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"existing_optimized"}]$raccourcia$::jsonb) as d(
...
select p.id, ia.id,
       ...
       d.support_notes
from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-046","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-046","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-046","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-081","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-081","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-081","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-082","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-082","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-082","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."}]$raccourcia$::jsonb) as d(
...
from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-046","sort_order":1,"variable":"personnages","question":"Que faut-il retenir pour « personnages » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-046","sort_order":2,"variable":"situation","question":"Que faut-il retenir pour « situation » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-081","sort_order":1,"variable":"besoins","question":"Que faut-il retenir pour « besoins » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-081","sort_order":2,"variable":"utilisateur","question":"À qui s’adresse le résultat ?","choices":["Clients","Prospects","Équipe interne","Autre"],"default_value":"Public principal du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-082","sort_order":1,"variable":"fonctionnalite","question":"Que faut-il retenir pour « fonctionnalite » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-082","sort_order":2,"variable":"regles","question":"Que faut-il retenir pour « regles » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."}]$raccourcia$::jsonb) as d(
...
begin
  ...
  if v_total < 267 then
    raise exception 'Lot 90 incomplet : % raccourcis importes au lieu de 267.', v_total;
  end if;
end $ctrl$;

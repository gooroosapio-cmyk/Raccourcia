-- Lot 66 : raccourcis 193 a 195 sur 320.
--
...
select * from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-024","command":"/checklist","slug":"checklist","name":"Checklist","mode":"texte","family_ref":"TXT-04","short_description":"Produit une checklist simple avec cases, ordre et controles.","result_summary":"Texte final pret a publier, envoyer ou integrer.","intention":"Transformer un processus en checklist.","use_cases":["Checklist à partir d'un contexte réel pour obtenir un livrable directement exploitable.","/checklist pour transformer un brief court en checklist exploitable."],"tags":["checklist","execution","operations"],"expected_input":"facultative","minimal_context":"Objectif et matière source ou brief compréhensibles.","sufficient_context":"Objectif, audience ou destinataire, source et format déductibles du contexte.","required_variables":["objectif"],"optional_variables":["ton","longueur","canal","exemples","mots_interdits"],"default_values":"Ton clair, direct et professionnel; longueur moyenne; structure scannable.","expected_output":"Texte final pret a publier, envoyer ou integrer.","output_format":"Titre + texte final + variante courte si utile.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"Ne remplace pas une validation juridique, medicale ou financiere; chiffres et sources doivent etre fournis.","usage_conditions":"Utiliser des données autorisées; anonymiser les informations sensibles; faire valider les domaines réglementés.","fallback_if_incomplete":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","blocking_condition":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":1,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P0","is_featured":true,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/travail-organisation/checklist.webp","default_image_alt":"Checklist — illustration éditoriale","legacy_category":"Travail & pilotage","legacy_subcategory":"Documents & opérations","sort_order":4,"version_label":"v2.1","payload":"[RaccourcIA — /checklist]\nRôle : exécuter « Checklist ».\nObjectif : Transformer un processus en checklist.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : objectif.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 1 questions.\n1. Quel résultat est prioritaire ? A. Informer B. Convaincre C. Décider D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nProduit une checklist simple avec cases, ordre et controles.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nTitre + texte final + variante courte si utile.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/checklist pour transformer un brief court en checklist exploitable.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « objectif » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"existing_optimized"},{"external_ref":"RCI-TXT-025","command":"/meetingagenda","slug":"meetingagenda","name":"Ordre du jour","mode":"texte","family_ref":"TXT-04","short_description":"Cree objectifs, timing, participants, questions et decisions attendues.","result_summary":"Texte final pret a publier, envoyer ou integrer.","intention":"Preparer un ordre du jour efficace.","use_cases":["Agenda réunion à partir d'un contexte réel pour obtenir un livrable directement exploitable.","/meetingagenda pour transformer un brief court en agenda réunion exploitable."],"tags":["réunion","agenda","management"],"expected_input":"facultative","minimal_context":"Objectif et matière source ou brief compréhensibles.","sufficient_context":"Objectif, audience ou destinataire, source et format déductibles du contexte.","required_variables":["sujet","participants"],"optional_variables":["ton","longueur","canal","exemples","mots_interdits"],"default_values":"Ton clair, direct et professionnel; longueur moyenne; structure scannable.","expected_output":"Texte final pret a publier, envoyer ou integrer.","output_format":"Titre + texte final + variante courte si utile.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"Ne remplace pas une validation juridique, medicale ou financiere; chiffres et sources doivent etre fournis.","usage_conditions":"Utiliser des données autorisées; anonymiser les informations sensibles; faire valider les domaines réglementés.","fallback_if_incomplete":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","blocking_condition":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P0","is_featured":true,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/travail-organisation/meetingagenda.webp","default_image_alt":"Ordre du jour — illustration éditoriale","legacy_category":"Travail & pilotage","legacy_subcategory":"Documents & opérations","sort_order":5,"version_label":"v2.1","payload":"[RaccourcIA — /meetingagenda]\nRôle : exécuter « Ordre du jour ».\nObjectif : Preparer un ordre du jour efficace.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : sujet; participants.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Quel sujet faut-il traiter ? A. Objet joint B. Personne jointe C. Lieu ou scène D. Autre\n2. Que faut-il retenir pour « participants » ? A. Déduire du contexte B. Option standard C. Proposer des variantes D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nCree objectifs, timing, participants, questions et decisions attendues.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nTitre + texte final + variante courte si utile.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/meetingagenda pour transformer un brief court en agenda réunion exploitable.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « sujet » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"existing_optimized"},{"external_ref":"RCI-TXT-026","command":"/followup","slug":"followup","name":"Suivi action","mode":"texte","family_ref":"TXT-04","short_description":"Resume decisions, actions, responsables et echeances.","result_summary":"Texte final pret a publier, envoyer ou integrer.","intention":"Rediger un message de suivi apres réunion.","use_cases":["Suivi action à partir d'un contexte réel pour obtenir un livrable directement exploitable.","/followup pour transformer un brief court en suivi action exploitable."],"tags":["followup","réunion","email"],"expected_input":"facultative","minimal_context":"Objectif et matière source ou brief compréhensibles.","sufficient_context":"Objectif, audience ou destinataire, source et format déductibles du contexte.","required_variables":["notes","destinataires"],"optional_variables":["ton","longueur","canal","exemples","mots_interdits"],"default_values":"Ton clair, direct et professionnel; longueur moyenne; structure scannable.","expected_output":"Texte final pret a publier, envoyer ou integrer.","output_format":"Titre + texte final + variante courte si utile.","quality_criteria":"Exactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.","preserve_rules":"Intention, faits, chiffres, sources, contraintes et voix fournis.","avoid_rules":"Invention, remplissage, surpromesse, citation fictive, jargon et répétition.","limitations":"Ne remplace pas une validation juridique, medicale ou financiere; chiffres et sources doivent etre fournis.","usage_conditions":"Utiliser des données autorisées; anonymiser les informations sensibles; faire valider les domaines réglementés.","fallback_if_incomplete":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","blocking_condition":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","questionnaire_mode":"conditional","max_questions":2,"input_type":"text","output_type":"text","risk_level":"faible","priority":"P0","is_featured":true,"show_image_card":false,"card_image_mode":"editorial_cover","default_image_path":"prompt-media/defaults/texte/travail-organisation/followup.webp","default_image_alt":"Suivi action — illustration éditoriale","legacy_category":"Travail & pilotage","legacy_subcategory":"Documents & opérations","sort_order":6,"version_label":"v2.1","payload":"[RaccourcIA — /followup]\nRôle : exécuter « Suivi action ».\nObjectif : Rediger un message de suivi apres réunion.\n\n1. COMPRENDRE LE CONTEXTE\nAnalyse d’abord le message, la conversation et les pièces jointes. Utilise uniquement les faits, données et contraintes disponibles. Si le contexte suffit, produis directement le livrable.\nEntrée principale : texte. Entrées acceptées : brief; texte; notes; document facultatif.\nVariables indispensables : notes; destinataires.\n\n2. MINI-QCM CONDITIONNEL\nSi une information indispensable manque, pose ces questions dans un seul message, sans dépasser 2 questions.\n1. Quelle source dois-je utiliser ? A. Pièce jointe B. Texte collé C. Lien fourni D. Autre\n2. À qui s’adresse le résultat ? A. Clients B. Prospects C. Équipe interne D. Autre\nNe pose aucune question dont la réponse est déjà fournie ou déductible avec confiance.\n\n3. EXÉCUTION\nResume decisions, actions, responsables et echeances.\nSépare clairement les faits, hypothèses, calculs et recommandations. N’invente ni chiffre, ni source, ni citation.\n\n4. SORTIE\nTitre + texte final + variante courte si utile.\n\n5. CONTRÔLE QUALITÉ\nExactitude; clarté; structure; spécificité; format respecté; faits séparés des hypothèses; recommandations reliées aux éléments fournis.\nSignale brièvement les limites qui changent la fiabilité. Pour un sujet juridique, fiscal, médical, financier ou de sécurité, présente le résultat comme une aide préparatoire nécessitant une validation qualifiée.","usage_example":"/followup pour transformer un brief court en suivi action exploitable.","test_nominal":"Contexte complet → livrable final sans question.","test_incomplete_context":"Retirer « notes » → poser uniquement la question correspondante.","test_blocking":"Poser uniquement les questions indispensables si l'objectif ou la matière source manque.","catalog_version":"v2.1","source_status":"existing_optimized"}]$raccourcia$::jsonb) as d(
...
select p.id, ia.id,
       ...
       d.support_notes
from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-024","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-024","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-024","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-025","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-025","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-025","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."},{"external_ref":"RCI-TXT-026","provider_key":"chatgpt","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-026","provider_key":"claude","fallback_behavior":"execute_text","support_notes":"Compatible texte et documents selon les limites de contexte."},{"external_ref":"RCI-TXT-026","provider_key":"gemini","fallback_behavior":"execute_text","support_notes":"Compatible texte, documents et données selon les outils activés."}]$raccourcia$::jsonb) as d(
...
from jsonb_to_recordset($raccourcia$[{"external_ref":"RCI-TXT-024","sort_order":1,"variable":"objectif","question":"Quel résultat est prioritaire ?","choices":["Informer","Convaincre","Décider","Autre"],"default_value":"Objectif explicite","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-025","sort_order":1,"variable":"sujet","question":"Quel sujet faut-il traiter ?","choices":["Objet joint","Personne jointe","Lieu ou scène","Autre"],"default_value":"Sujet principal de la source","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-025","sort_order":2,"variable":"participants","question":"Que faut-il retenir pour « participants » ?","choices":["Déduire du contexte","Option standard","Proposer des variantes","Autre"],"default_value":"Déduire du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-026","sort_order":1,"variable":"notes","question":"Quelle source dois-je utiliser ?","choices":["Pièce jointe","Texte collé","Lien fourni","Autre"],"default_value":"Source fournie","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."},{"external_ref":"RCI-TXT-026","sort_order":2,"variable":"destinataires","question":"À qui s’adresse le résultat ?","choices":["Clients","Prospects","Équipe interne","Autre"],"default_value":"Public principal du contexte","trigger_note":"Poser uniquement si la réponse n’est ni fournie ni déductible avec confiance."}]$raccourcia$::jsonb) as d(
...
begin
  ...
  if v_total < 195 then
    raise exception 'Lot 66 incomplet : % raccourcis importes au lieu de 195.', v_total;
  end if;
end $ctrl$;
